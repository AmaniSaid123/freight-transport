...
$get_active_menu="comptabilite";
	$page_titre="Comptabilité - Grand Journal Condensé";
	$page_small_detail="Grand Journal";
	$page_location="Comptabilité > Grand Journal Condensé";
...
<?php  include_once("php/print_message.php"); ?>
 ...
 <form  onsubmit="ShowLoading()" class="form-horizontal" action="grand_journal_condensed.php"  method="post">
  ...
  <div class="box-header with-border">
		...
		$sql_select1 = "select ".$groupage_value." as groupage,sum(credit_action) as credit_action,sum(debit_action) as debit_action,code_operation, t.ref_devise, t.ref_user, ref_compte, t_livre_compte.label as compte, t_agence.label as agence "
                        . " ,
                        sum(solde_parent) as solde_parent from t_grand_journal t join t_livre_compte on (ref_compte=account_no and ref_agence_action=t_livre_compte.ref_agence)  join t_agence on ref_agence_action=id_agence ".$param_query." "
