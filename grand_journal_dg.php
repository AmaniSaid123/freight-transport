...
$get_active_menu="DG";
	$page_titre="Direction Générale > Grand Journal";
	$page_small_detail=" ";
	$page_location="Direction Générale > Grand Journal";
...
//****************location******************
  ...
  $param_query=" where  1 and date(t.creationdate)=date(now())";
  $limit="  limit 0,500";

  $_SESSION['_req'] = $param_query;
...
<form  onsubmit="ShowLoading()" class="form-horizontal" action="grand_journal_dg.php"  method="post">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Mode Liste</h3>
                    <br>
                    <button onclick="exportTableToCSV('ExportFileGrandJournal.csv')" class="btn btn-success pull-right" ><i class="fa  fa-file-excel-o fa-download"> Exporter en CSV </i> <i class="fa fa-download"></i>
                    </button>  
                ...
                <div class="box-body" style="overflow-y: scroll;">
                  ...
                  <?php if($index == 0): ?>
                      <button class="btn btn-info pull-left" disabled="disabled">
                        <i class="fa  fa-file-word-o fa-download">Exporter en WORD</i> <i class="fa fa-download"></i>
                      </button>

                      <button class="btn btn-warning pull-left" disabled="disabled"><i class="fa fa-file-pdf-o fa-download">Exporter en PDF</i> <i class="fa fa-download"></i>
                      </button><br>
                 
                    <?php else : ?>
                      <a href="Exports/print_grnd_journal_dg.php?print_word=valid&go_to_word=ok" target="_blank" class="btn btn-info pull-left">
                        <i class="fa  fa-file-word-o fa-download">Exporter en WORD</i> <i class="fa fa-download"></i>
                      </a>

                      <a href="Exports/print_grnd_j_pdf.php?print_pdf=valid&go_to_pdf=ok" target="_blank" class="btn btn-warning pull-left"><i class="fa fa-file-pdf-o fa-download">Exporter en PDF</i> <i class="fa fa-download"></i></a>
                  <?php endif; ?>
