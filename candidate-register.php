        ...
        <div class="heading">
            <div class="container">
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-lg-8">
                        <h2 class="heading-title">Finalisez Votre Inscription en Toute Sécurité</h2>
        ...
        <nav class="breadcrumbs">
            <div class="container">
                <ol>
                    ...
                    <li class="current">Formulaire de Renseignement VISA Etude</li>
                </ol>
            </div>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="container">
            ...
            <div class="row gy-4">
                <div class="row justify-content-center">
                    <div class="col-lg-12 py-5 py-xl-5 py-xxl-7 col-payment section-title">
                        <h2>Formulaire de Renseignement VISA Etude
                            <br></h2>
                        <div class="pt-5 p-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 row-style">
                                              ...
                                              <font color="#FF0000">*</font></label>
                                                    ...
                                                    <small class="text-danger"><?php echo $identiteError; ?></small>
                                            ...
                                            <div class="col-md-6 row-style">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger"><?php echo $lieuNaissanceError; ?></small>
                                            ...
                                            <div class="col-md-6 row-style">
                                                <div class="form-group">
                                                    ...
                                                    <div id="datepicker" class="input-group date" data-date-format="yyyy/mm/dd">
                                                        ...
                                                        } ?> type="text" readonly  data-inputmask="'alias': 'yyyy/mm/dd'" data-mask placeholder="Entrez votre date de naissance Année-Mois-Jour"  />
                                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                    </div>
                                                    <small class="text-danger"><?php echo $dateNaissanceError; ?></small>
                                            ...
                                            <div class="col-md-6 row-style">
                                                <div class="form-group">
                                                    ...
                                                    <div id="datepicker_expiration" class="input-group date" data-date-format="yyyy/mm/dd">
                                                        <input class="form-control" name="date_expiration_pp" type="text" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask placeholder="Entrez votre date d'expiration de votre passeport Jour-Mois-Année" />
                                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 row-style">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger"><?php echo $sexeError; ?></small>
                                                </div>
                                            </div>
                                            <div class="col-md-6 row-style">
                                            ...
                                            <div class="col-md-6 row-style">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger"><?php echo $telephoneError; ?></small>
                                            ...
                                            <div class="col-md-6 row-style">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger"><?php echo $promoteurAgenceError; ?></small>
                                            ...
                                            <div class="col-md-6 row-style">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger"><?php echo $adresseError; ?></small>
                                            ...
                                            <div class="col-md-6 row-style">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger"><?php echo $villePaysError; ?></small>
                                            ...
                                            <div class="col-md-6 row-style">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger"><?php echo $voDestinationError; ?></small>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="activite_passe_actuelle" cols="100%" rows="2" class="form-control activity"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 row-style">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger"><?php echo $pcQualiteGarantError; ?></small>
                                            ...
                                            <div class="col-md-6 row-style">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger"><?php echo $pcLieuTravailGrantError; ?></small>
