        ...
        try{
            ...
            if ($add_paiement) {
                if (!empty($email)) {
                    ...
                    $sujet = $subject;
                    include("candidate_sendmail_payment.php");
                }
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Effectuer Votre Paiement</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row gy-4">
          <div class="row justify-content-center">
            <div class="col-lg-8 py-5 py-xl-5 py-xxl-7 col-payment section-title">
                <h2>Effectuer Votre Paiement <br></h2>
              <div class="pt-5 p-4">
                ...
                <form class="row g-4 mt-3 payment-form" method="POST">
                  ...
                  <div class="form-group row mb-3 align-items-center">
                    ...
                    <div class="col-12 col-sm-6">
                      <select id="operation" name="ref_operation" class="form-select">
                  ...
                  <div class="col-sm-3 d-grid mt-4">
                    <button name="submit_add_paiement" type="submit">Suivant</button>
                  </div>
                </form>
              </div>
            </div>
