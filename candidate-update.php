        ...
        <nav class="breadcrumbs">
            <div class="container">
                <ol>
                    ...
                    <li class="current">Aperçu Dossier</li>
                </ol>
            </div>
        </nav>
    </div><!-- End Page Title -->
                        ...
                        <div class="pt-5 p-4">
                            ...
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" id="msform">
                                ...
                                <fieldset>
                                    ...
                                    <button type="submit" class="btn pull-right btn-submit-edit" name="btn_edition_identite_client">Valider les modifications de l'identité du client </button>
                                                            ...
                                                            while ($data1 = $sql_result1->fetch()) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <?php echo ($data_dossier['allow_edit_for_client'] == 1) ? '<a href="modification-dossier.php?action=edit_etude&idt_doc_study=' . $data1['idt_dossier_etude'] . '"><i class="bx bx-edit-alt me-1"></i></a>' : ""; ?>
                                                                        <?php echo ($data_dossier['allow_edit_for_client'] == 1 && 0) ? '<a href="modification-dossier.php?del_etude=yes&idt_doc_study=' . $data1['idt_dossier_etude'] . '" onClick="return confirm(' . "'Cette action va supprimer le cursus, Veuillez confirmer?'" . ')"><i class="bx bx-trash me-1"></i></a>' : ""; ?>
                                                                    </td>
                                                                </tr>
                            ...
                            <div class="modal fade" id="backDropModalSecondaire" data-bs-backdrop="static" tabindex="-1">
                                <div class="modal-dialog">
                                    <form class="modal-content" action="modification-dossier.php" method="post">
                            ...
                            <div class="modal fade" id="backDropModalDoc" data-bs-backdrop="static" tabindex="-1">
                                <div class="modal-dialog">
                                    <form class="modal-content" action="modification-dossier.php" method="post" enctype="multipart/form-data">
                                        <div class="modal-header">
