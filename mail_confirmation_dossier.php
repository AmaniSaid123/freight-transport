...
<h3 class="box-title">Reference d'enregistrement en Ligne (NDEL) : <?php  echo $data_dossier['ndel']; ?></h3>
<h3 class="box-title">Connectezn vous avec <a href="login.php" target="_blank">ICI</a> comme NID : <?php  echo $data_dossier['ndel']." et PIN : ".$data_dossier['pin_secret']; ?></h3>
