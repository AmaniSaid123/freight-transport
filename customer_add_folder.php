...
<?php
include_once("customer/layouts/head.php");
?>
...
<link href="back/assets/vendor/css/style.css" rel="stylesheet">
...
<main class="main" id="top">
    <?php
    include_once("customer/layouts/header.php");
    ?>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 py-5 py-xl-5 py-xxl-7">
                    <div class="pt-5 p-4 border rounded shadow-sm bg-light">
                        <h3 class="text-primary fw-bold text-center">Formulaire de Renseignement VISA Etude</h3>
