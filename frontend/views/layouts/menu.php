    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                <a href="homepage.php#home" class="nav-item nav-link active"><?= t('home') ?></a>
                <a href="homepage.php#about" class="nav-item nav-link"><?= t('about') ?></a>
                <a href="homepage.php#services" class="nav-item nav-link"><?= t('services') ?></a>
                <a href="homepage.php#tracking" class="nav-item nav-link"><?= t('tracking') ?></a>
                <a href="homepage.php#values" class="nav-item nav-link"><?= t('values') ?></a>
                <a href="homepage.php#process" class="nav-item nav-link"><?= t('proceed') ?></a>
                <a href="homepage.php#price" class="nav-item nav-link"><?= t('prices') ?></a>
