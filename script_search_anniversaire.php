...
//			$sms_send = send_sms("243814444577", "Rapport Souhait Anniversaire du ".date("d-m-Y").". Nbre SMS = ".$count_msg." | Nbre Mail = ".$count_mail, "PASSPORT", "NA", "User", "NA");
			$sms_send = send_sms("243815734275", "Rapport Souhait Anniversaire du ".date("d-m-Y").". Nbre SMS = ".$count_msg." | Nbre Mail = ".$count_mail, "PASSPORT", "NA", "User", "NA");
	}
