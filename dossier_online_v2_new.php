...
$get_active_menu = "dossier_online_v2_new";
...
if ((isset($_POST['submit_dossier']) && isset($_POST['identite']) && $_POST['identite'] != ""
  ...
  if ($feedback_dossier == 1) {
    ...
    $success_message = "Dossier en Ligne crée avec succès  <br>";
...
*/
    ...
    header("Location:authentification_online_v2.php?nid_client=" . $ndel . "&pin_secret=" . $pin_secret . "&msg=" . $success_message);
  } else {
    $error = "yes";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (empty($_POST["identite"])) {
    $identiteError = "Nom Complet obligatoire";
  } else {
                          ...
                          <div class="row">
                            <div class="col-md-6 row-style">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="identite" placeholder="Entrez votre Nom Postnom Prenom Exactement comme dans le Passeport">
                            ...
                            <div class="col-md-6 row-style">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="lieu_naissance" placeholder="Où êtes-vous né(e)?">
                            ...
                            <div class="col-md-6 row-style">
                              <div class="form-group">
                                ...
                                <div id="datepicker" class="input-group date" data-date-format="yyyy/mm/dd">
                                  <input class="form-control" name="date_naissance" type="text" readonly />
                            ...
                            <div class="col-md-6 row-style">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="promoteur_agence" placeholder=" Merci de donner tous les détails SVP. (Max 100 caractères)">
                            ...
                            <div class="col-md-6 row-style">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="adresse" placeholder="Entrez votre adresse (num, av, quartier et commune)">
                            ...
                            <div class="col-md-6 row-style">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="ville_pays" placeholder="Entrez votre ville et le pays (Ville , Pays)">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 row-style">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="pc_lieu_travail_garant" placeholder="Dites -nous lenom de son employeur">
                            ...
                            <div class="col-md-6 row-style">
                              <div class="form-group">
                                <label class="control-label">Email Facultatif <span class="span-style">Cette adresse email recevra les notifications habituelles sur le dossier</span></label>
