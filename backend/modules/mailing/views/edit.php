...
$page_titre = "Modifier l'Email";
$page_small_detail = "Édition";
$page_location = "Mailing > Modifier email";
...
// Convertir la date de programmation pour l'input datetime-local
if (!empty($formData['date_programmation']) && $formData['date_programmation'] !== '0000-00-00 00:00:00') {
    $formData['date_programmation'] = date('Y-m-d\TH:i', strtotime($formData['date_programmation']));
}

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    $result = $controller->handleUpdateMail($_POST, $mail_id);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="email-info">
                        ...
                        <?php if (!empty($mail['date_envoi']) && $mail['date_envoi'] !== '0000-00-00 00:00:00'): ?>
                            <div class="row mt-2">
                                <div class="col-12">
                                    <strong>Envoyé le:</strong> <?= $controller->formatDate($mail['date_envoi']) ?>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Modifier l'email</h6>
                        </div>
                        <div class="card-body">
                            <form class="form-horizontal needs-validation"
                                action="<?= htmlspecialchars($_SERVER['PHP_SELF']) . '?id=' . $mail_id ?>" 
                                method="post" 
                                id="mailForm"
                                novalidate>
                                ...
                                <div class="form-group row" id="destinatairesGroup" style="<?= ($formData['type_destinataires'] ?? '') == 'specifiques' ? '' : 'display: none;' ?>">
                                    <label class="col-sm-2 col-form-label">
                                        Destinataires
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-10 offset-sm-2">
                                        ...
                                        <a href="detail.php?id=<?= $mail_id ?>" class="btn btn-light">
