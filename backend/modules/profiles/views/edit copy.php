            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="<?php echo $data_profile['name']; ?>"
                                name="name" placeholder="identifiez le profile">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" rows="3" name="description"
                                placeholder="Descrivez le Ici ..."><?php echo $data_profile['description']; ?></textarea>
                        </div>
                    </div>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-info pull-right" name="submit"
                        onClick="return confirm('Cette action va modifier les accès du profile, Veuillez confirmer?')">Valider</button>
                </div><!-- /.box-footer -->
                  ...
                  while ($data1 = $sql_result1->fetch()) {
                    ...
                    ?>
                        ...
                        if ($data1['accorder'] == "Non") {
                          ...
                          ?>
                                            <input name="value<?php echo $index; ?>" type="hidden"
                                                value="<?php echo $data1['idcontent']; ?>"><input
                                                name="chk<?php echo $index; ?>" type="checkbox" value="on">
                                            <?php
                        } else {
                          ?>
                                            <a
                                                href="edit_profile.php?find=<?php echo $_SESSION['my_m_profile'] . "&del=" . $data1['idpc'] . "&menu=" . $data1['sous_menu']; ?>"><i
                                                    class="fa  fa-cut"></i></a>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <button type="submit" class="btn btn-info pull-right" name="submit_statut"
                                onClick="return confirm('Cette action va modifier les droits de vision des statuts, Veuillez confirmer?')">Valider</button>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                  ...
                  while ($data1 = $sql_result1->fetch()) {
                    ...
                    ?>
                        ...
                        if ($data1['accorder'] == "Non") {
                          ...
                          ?>
                                            <input name="value<?php echo $index_statut; ?>" type="hidden"
                                                value="<?php echo $data1['idt_statut_dossier']; ?>"><input
                                                name="chk<?php echo $index_statut; ?>" type="checkbox" value="on">
                                            <?php
                        } else {
                          ?>
                                            <a
                                                href="edit_profile.php?find=<?php echo $_SESSION['my_m_profile'] . "&del=" . $data1['idt_statu_dossier_profile'] . "&statut=" . $data1['label']; ?>"><i
                                                    class="fa  fa-cut"></i></a>
