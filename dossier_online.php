      ...
      $text_message = $data_statut['mail_client'];                
			...
			if($_POST['exetat_annee']!="" && $_POST['ecole_frequenter']!="" && $_POST['option']!=""  && $_POST['pourcentage']!=""  && $_POST['ville_obtention']!=""){
				...
				//$success_message=($add_document==1) ? $success_message." | - Document ajouté : ".add_action_no_request($data_dossier['idt_dossier'],6,'Valider','online_user','Oui','Ajout Document : Acte de naissance') : " | - Erreur Ajout Document";
					...
					header("Location:authentification_online.php?nid_client=".$ndel."&pin_secret=".$pin_secret."&msg=".$success_message);			
...
<h3 class="box-title">NID : <?php  echo date('mdHis'); ?></h3>
 ...
 <div class="box box-info">
  ...
  <div class="box-header with-border" id="section1">
              ...
              <!-- /.box -->
              <div class="box box-info" id="section2" style="overflow-y: scroll;height : 600px; " >
  ...
  <div class="box-header with-border">
                ...
                <!-- form start -->
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        <label  class="col-sm-6 control-label">Email Secondaire <span style = "font-size: 11px">(Cette adresse email recevra les notifications habituelles sur le dossier)</span></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label  class="col-sm-6 control-label">Numéro Facultatif <span style = "font-size: 11px">(Ce numéro ne recevra pas les notifications habituelles et ne sera utilisé que si nécessaire)</span></label>
                        <div class="col-sm-6">
...
fournir les recommandations et conseils nécessaires au client pour le bon traitement de son dossier. L'usage de "IL" représente le genre humain, incluant le masculin ou le féminin selon le cas.
					<div class="form-group">
                        <label  class="col-sm-6 control-label" ><font color="#FF0000">J'ai pris connaissance de ce qui est dit ci-haut et des <a href="privacy_page.php" target="_blank">conditions générales</a> et j'y adhère</font></label>
                      <div class="col-sm-6">
