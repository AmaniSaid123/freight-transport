		  	...
		  	?>	
                      ...
                      <?php 
						...
						if(get_access(18,$_SESSION['my_idprofile'])==1){
                         ...
                         ?>
                          <a href="journal_timeline.php?del=<?php echo $data1['idt_actions']; ?>" onClick="return confirm('Cette action va supprimer ce commentaire definitivement, Veuillez confirmer?')" ><i class="fa  fa-cut"></i> </a>
