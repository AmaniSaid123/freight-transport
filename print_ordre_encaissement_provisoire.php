...
if(isset($_GET['print_pdf']) && $_GET['print_pdf']=='ok' && clean_in_integer($_GET['idt_all'])>0){
    ...
    $textMessage = "NB : Cette facture est provisoire car votre paiement a d'abord été recu par un(e) agent(e) qui n'est pas finacier(e) en chef.";
    $textMessage2 = "Le financier en Chef analysera votre paiement puis le validera ou l'invalidera selon différentes raisons et vous serez notifié(e) par mail.";
    $textMessage3 = "Si après 48 heures aucun mail ne vous est envoyé, veuillez le reclamer à admin@passportsarl.voyage ou par uniquement message détaillé whatsapp au +243 81 573 42 75";
    ...
    if($data_transaction['is_exist']==1){
        ...
        $pdf->Cell(90);
        $pdf->Cell(30,10,'FACTURE PROVISOIRE : '.$data_transaction['code_transaction'],0,0,'C');
        $pdf->Ln(20);
        ...
        $pdf->Ln(5);
        $pdf->Cell('',10,utf8_decode($textMessage3),0,0,'L');
        $pdf->Ln(20);
