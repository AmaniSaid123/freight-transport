...
//$pin_secret=rand(10000,99999);
    ...
    if ($feedback_dossier == 1) {
        ...
        //header("Location : print_manifeste.php");			
    } else {
        $error = "yes";
...
<?php } ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="nid"  placeholder="Remplissez le NID" >
                        </div>
                    </div>
                    <div class="form-group">
...
for ($i = 1; $i <= 3; $i++) {
    ...
    <?php } ?>
                                ...
                                <td><input name="diplome_file_sec<?php echo $i; ?>" type="file"></td>                   
...
<?php } ?>
                        ...
                        <?php include("php/list_pays.php"); ?>
                            ...
                            <td><input name="exetat_file" type="file"></td>
    ...
    <?php } ?>
                                ...
                                <td><input name="diplome_file<?php echo $i; ?>" type="file"></td>                   
...
?>	    
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label  class="col-sm-6 control-label">Attachez votre CV en format modifiable</label>
                        <div class="col-sm-6">
                            <input name="cv_file" type="file" accept=".jpeg,.jpg,.png,.pdf,.docx,.doc">
                        </div>
                    </div>
