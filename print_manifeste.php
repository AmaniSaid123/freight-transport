...
<body>
  ...
  ?>
    ...
    <form action="dossier_online.php" method="post">
      <h3 class="box-title">Reference d'enregistrement en Ligne : <?php echo $data_dossier['ndel']; ?></h3>
      <h3 class="box-title">Connectez vous avec <a href="login.php" target="_blank">ICI</a> comme NID : <?php echo $data_dossier['ndel'] . " et PIN : " . $data_dossier['pin_secret']; ?></h3>
      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" name="email_secondaire" value="<?php echo $data_dossier['email_secondaire']; ?>" readonly="readonly">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" name="numero_telephone_secondaire" value="<?php echo $data_dossier['numero_telephone_secondaire']; ?>" readonly="readonly">
