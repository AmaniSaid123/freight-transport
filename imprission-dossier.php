                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-12">
                                                                        <table class="table borderless custom-table">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="style-td">Noms au complet</td>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="style-td">Noms au complet de votre père biologique</td>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="style-td">Noms au complet de votre mère biologique</td>
